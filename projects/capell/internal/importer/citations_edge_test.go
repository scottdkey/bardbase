...
func TestResolveCitations_NoTextLinesForWork(t *testing.T) {
	...
	res, err = database.Exec(`INSERT INTO lexicon_entries (key, base_key, letter) VALUES ('test','test','T')`)
	if err != nil {
...
func TestResolveCitations_DuplicateCitations(t *testing.T) {
	...
	res, _ = database.Exec(`INSERT INTO lexicon_entries (key, base_key, letter) VALUES ('Be','Be','B')`)
	entryID, _ := res.LastInsertId()
...
func TestResolveCitations_BelowFuzzyThreshold(t *testing.T) {
	...
	res, _ = database.Exec(`INSERT INTO lexicon_entries (key, base_key, letter) VALUES ('xyz','xyz','X')`)
	entryID, _ := res.LastInsertId()
...
func TestResolveCitations_NoQuoteNoLine(t *testing.T) {
	...
	res, _ = database.Exec(`INSERT INTO lexicon_entries (key, base_key, letter) VALUES ('test','test','T')`)
	entryID, _ := res.LastInsertId()
...
func TestResolveCitations_MultipleCitationsSameLine(t *testing.T) {
	...
	res, _ = database.Exec(`INSERT INTO lexicon_entries (key, base_key, letter) VALUES ('Question','Question','Q')`)
