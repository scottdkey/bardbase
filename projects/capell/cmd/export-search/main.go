...
--
-- Contains all core app tables plus FTS5 trigram indexes whose rowids match
-- their backing-table primary keys. FKs are declared but not enforced at
-- import time for speed; the web app never mutates this DB at runtime.
